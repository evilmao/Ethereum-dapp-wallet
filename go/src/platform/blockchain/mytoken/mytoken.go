...
func (_Token *TokenCaller) BuyPrice(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Token.contract.Call(opts, out, "buyPrice")
	return *ret0, err
}
...
//
// Solidity: function buyPrice() constant returns(uint256)
func (_Token *TokenSession) BuyPrice() (*big.Int, error) {
	return _Token.Contract.BuyPrice(&_Token.CallOpts)
}

// BuyPrice is a free data retrieval call binding the contract method 0x8620410b.
//
// Solidity: function buyPrice() constant returns(uint256)
func (_Token *TokenCallerSession) BuyPrice() (*big.Int, error) {
	return _Token.Contract.BuyPrice(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) SellPrice(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Token.contract.Call(opts, out, "sellPrice")
	return *ret0, err
}
...
//
// Solidity: function sellPrice() constant returns(uint256)
func (_Token *TokenSession) SellPrice() (*big.Int, error) {
	return _Token.Contract.SellPrice(&_Token.CallOpts)
}

// SellPrice is a free data retrieval call binding the contract method 0x4b750334.
//
// Solidity: function sellPrice() constant returns(uint256)
func (_Token *TokenCallerSession) SellPrice() (*big.Int, error) {
	return _Token.Contract.SellPrice(&_Token.CallOpts)
}
...
func (_Token *TokenTransactor) Buy(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "buy")
}

// Buy is a paid mutator transaction binding the contract method 0xa6f2ae3a.
//
// Solidity: function buy() returns()
func (_Token *TokenSession) Buy() (*types.Transaction, error) {
	return _Token.Contract.Buy(&_Token.TransactOpts)
}

// Buy is a paid mutator transaction binding the contract method 0xa6f2ae3a.
//
// Solidity: function buy() returns()
func (_Token *TokenTransactorSession) Buy() (*types.Transaction, error) {
	return _Token.Contract.Buy(&_Token.TransactOpts)
}
...
func (_Token *TokenTransactor) Sell(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "sell", amount)
}

// Sell is a paid mutator transaction binding the contract method 0xe4849b32.
//
// Solidity: function sell(amount uint256) returns()
func (_Token *TokenSession) Sell(amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Sell(&_Token.TransactOpts, amount)
}

// Sell is a paid mutator transaction binding the contract method 0xe4849b32.
//
// Solidity: function sell(amount uint256) returns()
func (_Token *TokenTransactorSession) Sell(amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Sell(&_Token.TransactOpts, amount)
}
...
func (_Token *TokenTransactor) SetPrices(opts *bind.TransactOpts, newSellPrice *big.Int, newBuyPrice *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setPrices", newSellPrice, newBuyPrice)
}

// SetPrices is a paid mutator transaction binding the contract method 0x05fefda7.
//
// Solidity: function setPrices(newSellPrice uint256, newBuyPrice uint256) returns()
func (_Token *TokenSession) SetPrices(newSellPrice *big.Int, newBuyPrice *big.Int) (*types.Transaction, error) {
	return _Token.Contract.SetPrices(&_Token.TransactOpts, newSellPrice, newBuyPrice)
}

// SetPrices is a paid mutator transaction binding the contract method 0x05fefda7.
//
// Solidity: function setPrices(newSellPrice uint256, newBuyPrice uint256) returns()
func (_Token *TokenTransactorSession) SetPrices(newSellPrice *big.Int, newBuyPrice *big.Int) (*types.Transaction, error) {
	return _Token.Contract.SetPrices(&_Token.TransactOpts, newSellPrice, newBuyPrice)
}
